...
void main() {
  group('AppSpinner', () {
    testWidgets('renderiza SpinKitFadingCircle con semantics live', (tester) async {
      await tester.pumpWidget(_wrap(const AppSpinner()));
      expect(find.byType(SpinKitFadingCircle), findsOneWidget);
      final semantics =
          tester.getSemantics(find.byType(AppSpinner));
    ...
    testWidgets('.small mide 20', (tester) async {
      ...
      final spinner =
          tester.widget<SpinKitFadingCircle>(find.byType(SpinKitFadingCircle));
