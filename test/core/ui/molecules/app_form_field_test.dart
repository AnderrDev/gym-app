  ...
  group('AppFormField', () {
    testWidgets('renderiza label en uppercase y valor inicial', (tester) async {
      await tester.pumpWidget(
        _wrap(
          AppFormField(label: 'email', value: 'foo@bar.com', onChanged: (_) {}),
        ),
      );
    ...
    testWidgets('obscureText muestra suffix icon de visibility', (
      tester,
    ) async {
      await tester.pumpWidget(
        _wrap(
    ...
    testWidgets('actualizar value desde fuera sincroniza el controller', (
      ...
      Widget build(String v) =>
          _wrap(AppFormField(label: 'name', value: v, onChanged: (_) {}));
